const { Message, frameLengthSize, messageTypeSize, keySize } = require('./message');

const FRAME_LENGTH_SIZE = frameLengthSize;
const FIRST_CHUNK_SIZE = FRAME_LENGTH_SIZE + messageTypeSize;
const FRAME_HEAD_SIZE = FIRST_CHUNK_SIZE + keySize
