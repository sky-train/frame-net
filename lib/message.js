...
module.exports = { 
  Message, 
  FRAME_LENGTH_SIZE: frameLengthSize,
  FIRST_CHUNK_SIZE: frameLengthSize + messageTypeSize,
  FRAME_HEAD_SIZE: frameLengthSize + messageTypeSize + keySize
};